...
# This is not my code this is taken from Udacity course for python 
# with minor changes
...
<head>
    <meta charset="utf-8">
    <!-- Changed to my own title -->
    <title>Umer's Favorite Movies!</title>
...
main_page_content = '''
  <body>
    ...
    <!-- Main Page Content -->
    <div class="container">
        <h1>My Favorite Movies <small>by replayability</small></h1>
        <hr>
    </div>
    <div class="container">
      {movie_tiles}
